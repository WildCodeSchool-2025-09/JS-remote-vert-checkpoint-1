...
function findSeniors(persons) {
  const seniorDevs = persons.filter(person => person.experience >= 5 && person.job === "web dev");
  const seniorData = persons.filter(person => person.experience >= 5 && person.job === "data analyst")
